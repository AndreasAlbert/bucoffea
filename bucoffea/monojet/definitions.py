...
def monojet_accumulator(cfg):
    ...
    items["ak4_sublead_ineta_pt30_pt"] = Hist("Counts", dataset_ax, region_ax, jet_pt_ax)
    items["ak4_sublead_ineta_pt30_eta"] = Hist("Counts", dataset_ax, region_ax, jet_eta_ax)
    items["ak4_sublead_ineta_pt30_phi"] = Hist("Counts", dataset_ax, region_ax, jet_phi_ax)
